...
import { getAllPersonas } from '../../../features/personaSlice'; // Importamos la acción para cargar los usuarios
...
const AgregarEstudiante = () => {
  ...
  const { personas } = useSelector(state => state.personas); // Accedemos a los usuarios
  ...
  useEffect(() => {
    ...
    dispatch(getGrados());
    dispatch(getAllPersonas()); // Cargamos los usuarios disponibles
      ...
      >
        <Stack spacing={4} direction="row" justifyContent="space-between" p={4}>
          <HStack spacing={4} direction="row">
            ...
            <Text fontSize={{ base: 'xs', lg: 'md' }} fontWeight={'black'}>
              Regresar
            </Text>
          </HStack>
          <HStack spacing={4} direction="row">
            <Text fontSize={{ base: 'xs', lg: 'lg' }} fontWeight={'black'}>
